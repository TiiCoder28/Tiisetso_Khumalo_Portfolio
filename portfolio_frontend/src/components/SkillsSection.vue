            ...
            <div class="space-y-4">
              ...
              >
                <div class="flex justify-between items-center mb-1">
                  ...
                  <span class="text-xs font-mono" :class="getColorClasses(category.color).text">
                    {{ skill.level }}%
                  </span>
                </div>
        ...
        <div class="flex flex-wrap justify-center gap-6">
          ...
          >
            ...
            <div class="relative flex items-center gap-4">
              <div class="flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br flex items-center justify-center text-3xl" :class="cert.color">
                {{ cert.icon }}
              </div>
              <div>
                ...
                <button
                  v-if="cert.certificateFile"
                  v-on:click="viewCertificate(cert)"
                  class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center mr-2 mb-2"
                >
                  View Certificate
                </button>
                <div v-else class="text-xs text-gray-400 mt-3">Credential verified</div>
              </div>
            </div>
